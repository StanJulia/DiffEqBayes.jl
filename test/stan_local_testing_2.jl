...
plot(chn)
!isdir("tmp") && mkdir("tmp")
savefig("$(@__DIR__)/tmp/one_par_case_02.png")
...
savefig("$(@__DIR__)/tmp/one_par_pred_prey_02.png")
...
chn = CmdStan.convert_a3d(bayesian_result.chains, bayesian_result.cnames, Val(:mcmcchains))
plot(chn)
savefig("$(@__DIR__)/tmp/one_par_case_03.png")
...
plot(p1, p2, layout=(2,1))
savefig("$(@__DIR__)/tmp/one_par_pred_prey_03.png")
...
bayesian_result = stan_inference(prob1,t,data,priors;num_samples=2000,
  num_warmup=1000,likelihood=Normal,save_idxs=[1],sample_u0=true)
...
chn = CmdStan.convert_a3d(bayesian_result.chains, bayesian_result.cnames, Val(:mcmcchains))
plot(chn)
savefig("$(@__DIR__)/tmp/one_par_case_04.png")
...
plot(p1, p2, layout=(2,1))
savefig("$(@__DIR__)/tmp/one_par_pred_prey_04.png")
